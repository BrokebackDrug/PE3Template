    ...
    publications {
        create<MavenPublication>("release") {
            ...
            pom {
                ...
                url.set("https://github.com/brokebackdrug/pe3template/")
                ...
                developers {
                    developer {
                        id.set("brokebackdrug")
                        name.set("brokebackdrug")
                    }
                }
                scm {
                    connection.set("scm:git:git://github.com/brokebackdrug/pe3template.git")
                    developerConnection.set("scm:git:ssh://github.com/brokebackdrug/pe3template.git")
                    url.set("https://github.com/brokebackdrug/pe3template/")
                }
                issueManagement {
                    system.set("GitHub Issues")
                    url.set("https://github.com/brokebackdrug/pe3template/issues")
                }
            }
        }
    }
